        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .requestMatchers("/api/service/add").hasAuthority("ROLE_ADMIN")
                                                .requestMatchers("/api/service/update/**").hasAuthority("ROLE_ADMIN")
                                                .requestMatchers("/api/service/delete/**").hasAuthority("ROLE_ADMIN")
